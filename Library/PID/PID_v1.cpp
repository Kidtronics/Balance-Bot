...
bool PID::Compute()
{
   ...
   if(timeChange>=SampleTime)
   {
      ...
      // clamp the inegrator value.
      if (integratorLimitIsSet) {
         if (outputSum > integratorMax) {
            outputSum = integratorMax;
         }
         else if (outputSum < integratorMin) {
            outputSum = integratorMin;
         }
      }
...
/** Clamp the value of integrator part of PID. */
